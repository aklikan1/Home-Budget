...
import { ROUTES_BUDGET } from '../sidebar/sidebar.component';
let NavbarComponent = class NavbarComponent {
    constructor(location, element, router, getApiService, tokenStorage) {
    ...
    ngOnInit() {
        ...
        this.listTitles = ROUTES_BUDGET.filter(listTitle => listTitle);
