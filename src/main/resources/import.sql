...
INSERT INTO `home_budget`.`user` (`descriptions`, `is_active`, `password`, `username`) VALUES ('User Description test', '1', '{noop}1234', 'admin');
INSERT INTO `home_budget`.`user` (`descriptions`, `is_active`, `password`, `username`) VALUES ('User 2 Description test', '1', '{noop}1234', 'user');
INSERT INTO `home_budget`.`user` (`descriptions`, `is_active`, `password`, `username`) VALUES ('User 3 Description test', '1', '{noop}a', 'a');
