...
public class ExpensesBasicNames {
	...
	@ManyToMany (mappedBy = "expensesBasicNames")
	...
	public ExpensesBasicNames(@NotNull String name) {
		this.name = name;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ExpensesBasicNames other = (ExpensesBasicNames) obj;
	...
	public String toString() {
		return "ExpensesBasicNames [id=" + id + ", name=" + name + ", budgetExpenses=" + budgetExpenses + ", user="
				+ user + "]";
	}
}
